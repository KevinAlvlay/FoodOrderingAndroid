package com.example.foodorderingandroid.adapter;
...
import com.example.foodorderingandroid.activity.ShopDetailActivity;
...
public class ShopAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bean != null) {
            ...
            // 设置图片来源
            vh.iv_shop_pic.setBackgroundResource(bgs[bean.getId() - 1]);
        }
        //每个Item的点击事件
